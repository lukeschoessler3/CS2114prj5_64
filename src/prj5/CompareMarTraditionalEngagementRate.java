...
// -------------------------------------------------------------------------
/**
 * Compares the March traditional engagement rates
 * 
 * @author Luke Schoessler
 * @version Apr 22, 2024
 */
public class CompareMarTraditionalEngagementRate
    implements Comparator<Influencer>
{

// ----------------------------------------------------------
    /**
     * Compare two influencer's march traditional engagement rates (ints)
     * 
     * @param left

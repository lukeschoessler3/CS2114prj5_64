...
// -------------------------------------------------------------------------
/**
 * Compares the January traditional engagement rates
 * 
 * @author Luke Schoessler
 * @version Apr 22, 2024
 */
public class CompareJanTraditionalEngagementRate
    implements Comparator<Influencer>
{

// ----------------------------------------------------------
    /**
     * Compare two influencer's january traditional engagement rates (ints)
     * 
     * @param left
